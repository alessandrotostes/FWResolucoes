document.addEventListener('DOMContentLoaded', () => {
    ...
    const fadeElements = document.querySelectorAll('h1, h2, h3, p, .img-animate, .bento-item');
    
    // Configura estado inicial das animações por JS
    fadeElements.forEach((el) => {
        el.style.opacity = '0';
        el.style.transform = el.classList.contains('img-animate') || el.classList.contains('bento-item')
            ? 'translateY(30px)' 
            : 'translateY(20px)';
